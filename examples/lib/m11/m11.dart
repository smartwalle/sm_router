...
void main() {
  ...
  RouteCenter.handle("/m11/view1", (ctx) => const Home(currentIndex: 0)).setKey(const ValueKey("home"));
  RouteCenter.handle("/m11/view2", (ctx) => const Home(currentIndex: 1)).setKey(const ValueKey("home"));
  RouteCenter.handle("/m11/view3", (ctx) => const Home(currentIndex: 2)).setKey(const ValueKey("home"));
