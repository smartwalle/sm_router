...
void main() {
  ...
  RouteCenter.handle("/m11/view1", (ctx) => Home(key: ctx.key, currentIndex: 0)).setKey(const ValueKey("home"));
  RouteCenter.handle("/m11/view2", (ctx) => Home(key: ctx.key, currentIndex: 1)).setKey(const ValueKey("home"));
  RouteCenter.handle("/m11/view3", (ctx) => Home(key: ctx.key, currentIndex: 2)).setKey(const ValueKey("home"));
